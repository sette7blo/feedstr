...
const requiredIdenstrScopes = ['profile:read', 'following:read', 'following:write', 'mutes:read', 'mutes:write', 'relays:read', 'sign:kind:1', 'sign:kind:5', 'sign:kind:6', 'sign:kind:7', 'sign:kind:27235', 'zaps:write', 'schedule:read', 'schedule:write'];
